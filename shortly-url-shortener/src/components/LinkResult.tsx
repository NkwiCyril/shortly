  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <p className="p-4 border-b md:border-b-0 text-very-dark-violet truncate">
          {displayUrl}
        </p>
        ...
        <div className="p-4 flex flex-col md:flex-row md:items-center md:space-x-6">
          <a 
            ...
            className="text-cyan font-medium mb-3 md:mb-0"
          >
            {shortUrl}
          </a>
          ...
          <button
            onClick={handleCopy}
            className={`${
              copied ? 'bg-dark-violet' : 'bg-cyan hover:bg-cyan-light'
